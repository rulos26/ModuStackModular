        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('reportes.index') }}" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                        <i class="fas fa-chart-bar mr-1"></i>Reportes
                    </a>
                    <a href="{{ route('ia.index') }}" class="text-purple-600 hover:text-purple-900 px-3 py-2 rounded-md text-sm font-medium bg-purple-50 rounded-lg">
